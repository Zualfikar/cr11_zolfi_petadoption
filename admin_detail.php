...
<div class="card" style="">
  ...
  <div class="card-body">
<a href="update.php?id=<?php echo $row['animal_id'] ?>" class=""><button type="button" class="btn btn-info">Update</button></a>
<a href="delete.php?id=<?php echo $row['animal_id'] ?>" class=""><button type="button" class="btn btn-info">Delete</button></a>
